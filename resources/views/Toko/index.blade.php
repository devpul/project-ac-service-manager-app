    ...
    <div class="flex flex-col gap-y-10 w-[90%] mx-auto">
        ...
        <div class="flex flex-col justify-between items-start md:items-center gap-4 my-2 w-full mx-auto">
            ...
            <div class="flex justify-between w-full">
                ...
                <a href="{{ route('toko.create') }}" class="bg-green-600 hover:bg-green-700 text-white font-bold py-1 px-4 rounded-full shadow transition duration-300">
                    Import
                </a>
            </div>
        </div>
        ...
        <div class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                @forelse ($tokos as $toko)
                    <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden border border-gray-200 flex flex-col h-full">
